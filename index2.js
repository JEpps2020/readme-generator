...
function generateReadme(responseobj){
    return responseobj.githubusername+responseobj.title+responseobj.description+responseobj.installation+responseobj.usage+ responseobj.licenses+responseobj.contributing+responseobj.tests;
